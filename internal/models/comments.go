...
func (CM *CommentModel) GetComments(user *UserModel, postId int, authorID int) ([]*PostComments, error) {
...
func (CM *CommentModel) CommentLikeInsert(likeData CommentLikeData, likedBy int) error {
	...
	if count > 0 {
		...
		CM.RemoveCommentDislike(likeData.CommentID, likedBy)
...
func (CM *CommentModel) CommentDislikeInsert(dislikeData CommentDislikeData, dislikedBy int) error {
	...
	if count > 0 {
		...
		CM.RemoveCommentLike(dislikeData.CommentID, dislikedBy)
